      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-4 sm:p-6 animate-fade-in">
        ...
        {loading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-1">No services yet</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Create your first service to start accepting bookings.</p>
