    ...
    <Layout className="bg-[#F8FAFC]">
      <main className="flex-1 max-w-5xl w-full mx-auto p-4 sm:p-6 animate-fade-in text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          {/* Profile Card */}
          <Card className="bg-white border border-slate-200 lg:col-span-2 p-6 space-y-5">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-blue-600 flex items-center justify-center text-white font-extrabold text-xl shadow-sm">
            ...
            <div className="border-t border-slate-100 pt-5 space-y-4 font-semibold text-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-1 py-1">
                ...
                <span className="sm:col-span-2 text-slate-800 capitalize">
                  {user?.city || "Not configured"}
                </span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-1 py-1">
                <span className="text-slate-400 font-medium font-bold">
                ...
                <span className="sm:col-span-2">
                  <Badge variant="emerald" className="font-bold uppercase">
                    {user?.role}
                  </Badge>
                </span>
              </div>
          ...
          {/* Quick Actions */}
          <Card className="bg-white border border-slate-205 p-6 flex flex-col justify-between gap-5">
            <div className="space-y-2">
              <h3 className="text-base font-bold text-slate-900">
                Quick Actions
              </h3>
              <p className="text-sm text-slate-500 leading-normal">
                Browse slot schedules, select verified local experts or track
                historical appointments.
              </p>
            </div>
            <div className="flex flex-col gap-3">
              <Link to="/providers" className="block w-full">
                <Button className="w-full justify-center font-bold text-sm gap-2">
                  <svg
              ...
              <Link to="/bookings" className="block w-full">
                <Button
                  variant="secondary"
                  className="w-full justify-center font-bold text-sm gap-2"
                >
                  <svg
                    className="w-4 h-4 shrink-0"
                    fill="none"
