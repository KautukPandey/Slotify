      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-4 sm:p-6 animate-fade-in">
        ...
        {loading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <p className="text-sm text-slate-500 dark:text-zinc-400">Customer bookings will appear here once they start scheduling.</p>
          </div>
        ) : (
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="text-sm text-slate-600 dark:text-zinc-400 space-y-1">
                        <p className="flex items-center gap-2">
                          ...
                          <span><span className="font-medium text-slate-500 dark:text-zinc-500">Customer:</span> {booking.customer?.name || "N/A"} ({booking.customer?.email || "N/A"})</span>
                        </p>
                        <p className="flex items-center gap-2">
                          <svg className="w-4 h-4 text-slate-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
