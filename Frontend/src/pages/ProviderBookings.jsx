  ...
  return (
    <Layout>
      <main className="flex-1 max-w-5xl w-full mx-auto p-4 sm:p-6 animate-fade-in">
        <PageHeader title="Customer Bookings" subtitle="Track appointments, review notes, and mark sessions as completed" />
        ...
        {loading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Customer bookings will appear here once they start scheduling.</p>
          </div>
        ) : (
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="text-sm text-slate-600 dark:text-slate-400 space-y-1">
                        <p className="flex items-center gap-2">
                          ...
                          <span><span className="font-medium text-slate-500 dark:text-slate-500">Customer:</span> {booking.customer?.name || "N/A"} ({booking.customer?.email || "N/A"})</span>
                        </p>
                        <p className="flex items-center gap-2">
                          <svg className="w-4 h-4 text-slate-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                      ...
                      {isConfirmed && (
                        ...
                        >
                          {isActionLoading ? (
                            ...
                            <><svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>Mark Completed</>
                          )}
                        </button>
                      )}
                    </div>
